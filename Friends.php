...
error_reporting(E_ALL ^ E_DEPRECATED);
    ...
    if(isset($_SESSION['UserID']) && !empty($_SESSION['UserID'])) {
           ...
           if(isset($_POST['Search']) && !empty($_POST['Search'])){
                ...
                $list = $DB->SearchForFriend($UserID,$SearchUsername);
           }else{
                $list = $DB->getFriendsList($UserID);
           }
    }else{
        ...
        <div class="container" style="width:90%;margin-top:5%">
            <div class="row">
                <?php 
                        ...
                        <form action='FriendsProfile.php' method='post'  style=' border: 1px dashed #ddd;border-radius:5px;
